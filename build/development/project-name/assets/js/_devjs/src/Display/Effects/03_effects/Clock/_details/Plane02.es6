...
export default class Plane {
  ...
  setup() {
    ...
    shaderSerialLoad(shaderLoadList.length,(shaders)=>{
      ...
      // タイムラインのsetup
      gb.in.ClockEf.timeline.setup();
      // シェーダーをロード完了したらloopは開始しておく
      gb.in.ClockEf.loop.start();
  ...
  create() {
    ...
    // var textureList = [
    //   '/project-name/assets/img/blue.png',
    //   '/project-name/assets/img/brown.png'
    // ];      
    // var textures = [];
    ...
    //   this.setEvents();
      ...
      // var vFOV = gb.in.camera.fov * Math.PI / 180;  // convert vertical fov to radians
      // var dist = gb.in.camera.camera.position.z - this.plane02.position.z;//The distance from the camera to the front face (important!) of the cube is 750 - 500 - 50 = 200. 
