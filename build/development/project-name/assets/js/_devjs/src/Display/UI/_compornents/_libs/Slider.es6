...
export default class Slider {
  ...
  constructor($target) {
    ...
    // dom
    this.$img = $('.section05 .imgWrap .img');

    this.$arrowL = $('.section05 .arrowL');
    this.$arrowR = $('.section05 .arrowR');

    this.$text = $('.section05 .text');
    ...
    this.textList = [
      '￥45,000／マイケル・コース ジャパン',
      '￥47,000／マイケル・コース ジャパン',
      '￥45,000／マイケル・コース ジャパン',
      '￥45,000／マイケル・コース ジャパン',
      '￥49,000（銀座店限定）／マイケル・コース ジャパン'
    ];
